...
public interface RoomInMemberRepository extends JpaRepository<RoomInMember, Long> {
    ...
    @Query("SELECT rim FROM RoomInMember rim WHERE rim.member = :member AND rim.expired = :expired")
    List<RoomInMember> findByMemberAndExpired(@Param("member") Member member, @Param("expired") String expired);

    @Query("SELECT rim FROM RoomInMember rim WHERE rim.room = :room")
    List<RoomInMember> findByRoom(@Param("room") Room room);
    ...
    List<RoomInfoIncludeMessageVO> findIncludeMessageByRoomAndMember(@Param("room") Room room, @Param("member") Member member);
    ...
    Optional<RoomInfoExceptMessageVO> findExceptMessageByRoomAndMember(@Param("room") Room room, @Param("member") Member member);
    ...
    Optional<RoomInMember> findOpponentByRoomAndMemberAndExpired(@Param("room") Room room, @Param("member") Member member, @Param("expired") String expired);
