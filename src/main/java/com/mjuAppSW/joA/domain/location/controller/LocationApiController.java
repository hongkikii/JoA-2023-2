package com.mjuAppSW.joA.domain.location.controller;

import com.mjuAppSW.joA.common.dto.SuccessResponse;
import com.mjuAppSW.joA.domain.location.dto.response.NearByListResponse;
import com.mjuAppSW.joA.domain.location.dto.request.UpdateRequest;
import com.mjuAppSW.joA.domain.location.dto.response.UpdateResponse;
import com.mjuAppSW.joA.domain.location.service.LocationService;
...
public class LocationApiController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403-1", description = "M003: 일시 정지된 계정입니다.", content = @Content(schema = @Schema(hidden = true))),
            ...
            @ApiResponse(responseCode = "404-3", description = "P001: 학교 정보를 찾을 수 없습니다.", content = @Content(schema = @Schema(hidden = true))),
    })
    @PatchMapping
